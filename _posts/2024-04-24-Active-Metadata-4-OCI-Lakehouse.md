...
Therefore, I create two events rule, one that executes an OCI Function in case the pipeline task runs successfully, and the other that executes another OCI Function in case the same task ends with errors.
