...
![Fig.1: Sample of physical deployment of Lakehouse architecture with Disaster Recovery](/_posts/images/2023-04-20-OCI-Golden-Gate-Disaster-Recovery-Architecture-(Part-I)/6524352535.png)
...
![Fig.2: Initial configuration: target ADW with Autonomous Data Guard enabled and OCI GoldenGate with single deployment](/_posts/images/2023-04-20-OCI-Golden-Gate-Disaster-Recovery-Architecture-(Part-I)/6050731718.png)
...
         ![](/_posts/images/2023-04-20-OCI-Golden-Gate-Disaster-Recovery-Architecture-(Part-I)/6276959885.png)

         ![Fig.3: RegionA, connections assigned to OCI GoldenGate deployment](/_posts/images/2023-04-20-OCI-Golden-Gate-Disaster-Recovery-Architecture-(Part-I)/6276959907.png)
...
       ![Fig.4: RegionA: OCI GoldenGate extract and replicat process](/_posts/images/2023-04-20-OCI-Golden-Gate-Disaster-Recovery-Architecture-(Part-I)/6276960234.png)
...
         ![Fig.5: RegionA, Autonomous Data Guard enablement](/_posts/images/2023-04-20-OCI-Golden-Gate-Disaster-Recovery-Architecture-(Part-I)/6050737112.png)

         ![Fig.6: RegionA, Autonomous Data Warehouse Primary instance for disaster recovery](/_posts/images/2023-04-20-OCI-Golden-Gate-Disaster-Recovery-Architecture-(Part-I)/6050737123.png)

         ![Fig.7: RegionB, Autonomous Data Warehouse Standby instance for disaster recovery](/_posts/images/2023-04-20-OCI-Golden-Gate-Disaster-Recovery-Architecture-(Part-I)/6275398387.png)
...
![Fig.8: Disaster recovery architecture including OCI GoldenGate](/_posts/images/2023-04-20-OCI-Golden-Gate-Disaster-Recovery-Architecture-(Part-I)/6050731718.png)
...
![Fig.9: Bucket to store OCI GoldenGate manual backups](/_posts/images/2023-04-20-OCI-Golden-Gate-Disaster-Recovery-Architecture-(Part-I)/6275381367.png)
...
![Fig.10: Shell script example with the "oci-cli" command to store OCI GoldenGate manual backups in Object Storage](/_posts/images/2023-04-20-OCI-Golden-Gate-Disaster-Recovery-Architecture-(Part-I)/6228856711.png)

Then you can schedule it with Linux crontab to be executed, for instance, every four hours:

![Fig.11: Scheduling of the shell script with Linux crontab](/_posts/images/2023-04-20-OCI-Golden-Gate-Disaster-Recovery-Architecture-(Part-I)/6228856788.png)
...
![Fig.12: Object Storage bucket replication policy](/_posts/images/2023-04-20-OCI-Golden-Gate-Disaster-Recovery-Architecture-(Part-I)/6209012559.png)
...
         ![](/_posts/images/2023-04-20-OCI-Golden-Gate-Disaster-Recovery-Architecture-(Part-I)/6275395167.png)

         ![Fig.13: RegionB, connections assigned to OCI GoldenGate deployment](/_posts/images/2023-04-20-OCI-Golden-Gate-Disaster-Recovery-Architecture-(Part-I)/6275395178.png)
...
           ![Fig.14: RegionB, first OCI GoldenGate manual backup](/_posts/images/2023-04-20-OCI-Golden-Gate-Disaster-Recovery-Architecture-(Part-I)/6275381382.png)

           ![Fig.15: RegionB, OCI GoldenGate backup](/_posts/images/2023-04-20-OCI-Golden-Gate-Disaster-Recovery-Architecture-(Part-I)/6276947759.png)

As expected the file produced by the manual backup, named _bkp-ocigg_, is visible in the bucket _GG-backup-RegionB_:

          ![Fig.16: RegionB, OCI GoldenGate backup file in the Object Storage bucket](/_posts/images/2023-04-20-OCI-Golden-Gate-Disaster-Recovery-Architecture-(Part-I)/6276947784.png)
...
          ![Fig.17: RegionB, OCI GoldenGate deployment without any extract/replicat process](/_posts/images/2023-04-20-OCI-Golden-Gate-Disaster-Recovery-Architecture-(Part-I)/6275394992.png)
...
![Fig.18: RegionB, OCI Function application creation](/_posts/images/2023-04-20-OCI-Golden-Gate-Disaster-Recovery-Architecture-(Part-I)/6275387637.png)
...
           ![Fig.19: RegionB, copy object OCI Function details](/_posts/images/2023-04-20-OCI-Golden-Gate-Disaster-Recovery-Architecture-(Part-I)/6275387590.png)
...
![Fig.20: RegionB, event rule configuration](/_posts/images/2023-04-20-OCI-Golden-Gate-Disaster-Recovery-Architecture-(Part-I)/6283046930.png)
...
![Fig.21: Full primary/secondary Region architecture configuration](/_posts/images/2023-04-20-OCI-Golden-Gate-Disaster-Recovery-Architecture-(Part-I)/6284983879.png)
